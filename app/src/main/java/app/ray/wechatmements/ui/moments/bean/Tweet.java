...
public class Tweet implements MomentsItem {

    //TODO find a way to skip any kind of format error with Gson
    /**
     * error: "losted"  --  special case
     * unknown error : STARCRAFT2  --  special case
     * content : 沙发！
