...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private SparseBooleanArray mExpandStatus;
    ...
    public void onClick(View view) {
        ...
        if (mExpandStatus != null) {
            mExpandStatus.put(mPosition, !mCollapsed);
        }
    ...
    public void setExpend(boolean expend) {
        ...
        if (mCollapsed) {
            ...
            this.getLayoutParams().height = mCollapsedHeight;
            this.requestLayout();
        } else {
            int expendHeight = getHeight() + mTextHeightWithMaxLines - mTv.getHeight();
            mTv.setMaxHeight(expendHeight - mMarginBetweenTxtAndBottom);
            this.getLayoutParams().height = expendHeight;
            this.requestLayout();
        }
    }
    ...
    public void setText(@Nullable CharSequence text, @NonNull SparseBooleanArray expandStates, int position) {
        mExpandStatus = expandStates;
        mPosition = position;
        boolean isExpand = false;
        if(position < mExpandStatus.size()){
            isExpand = mExpandStatus.get(position);
        } else {
            mExpandStatus.put(position, false);
        }
        clearAnimation();
        mCollapsed = !isExpand;
        mStateTv.setText(mCollapsed ? mExpandString : mCollapsedString);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        content = typedArray.getText(R.styleable.ExpandableTextView_text);
    ...
    private void findViews() {
        ...
        if (mExpandDrawable != null && mCollapseDrawable != null) {
            ...
            mStateTv.setPadding(0, mStateTv.getPaddingTop(), 0, mStateTv.getPaddingBottom());
        }
    ...
    private static int getRealTextViewHeight(@NonNull TextView textView) {
        int textHeight = -1;
//        try {
//            Method method = TextView.class.getDeclaredMethod("getDesiredHeight");
//            method.setAccessible(true);
//            textHeight = (int) method.invoke(textView);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        if (textHeight == -1) {
            textHeight = textView.getLayout().getLineTop(textView.getLineCount());
            textHeight = textHeight + textView.getCompoundPaddingTop() + textView.getCompoundPaddingBottom();
//        }
        return textHeight;
    }
